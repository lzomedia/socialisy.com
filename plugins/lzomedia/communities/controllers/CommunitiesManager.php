<?php namespace LzoMedia\Communities\Controllers;
 ...
 */
class CommunitiesManager extends Controller
{
    public $implement = [
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('LzoMedia.Communities', 'communities', 'communities-manager');
    }
